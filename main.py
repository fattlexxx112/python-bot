...
BOT_TOKEN = "7005107529:AAEX5PQdiTSPZg0OtURZo1cQxzOXO--wpc4"
PAYMENT_CHANNEL = "@fattleXpro" #add payment channel here including the '@' sign
OWNER_ID = 6443911092 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@fattleXpro"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
